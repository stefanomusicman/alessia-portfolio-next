  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* Light mode palette: Apache (bg), Tom Thumb, Hippie Green, Asparagus, Deco */
        stroke: "#c4b896",
        strokedark: "#2D2F40",
        hoverdark: "#252A42",
        titlebg: "#c8d69a",
        ...
        zumthor: "#EDF5FF",
        socialicon: "#D1D8E0",
        /* Named palette for light mode */
        apache: "#d9b56d",
        "tom-thumb": "#3a5940",
        "hippie-green": "#4a784a",
        asparagus: "#77a35c",
        deco: "#c8d69a",
        /* Soft surface for cards/panels in light mode (warm off-white) */
        surface: "#f7f4ef",
      },
      fontSize: {
        metatitle: ["12px", "20px"],
