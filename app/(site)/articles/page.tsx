...
const BlogPage = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      const fetchedArticles = await SanityService.getArticlesByCategory('Environment');
          ...
          <div className="relative">
            <details className="group">
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-50 dark:bg-blacksection">
                <div className="py-1">
                  <p className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:cursor-pointer dark:bg-blacksection dark:text-white">
                    Category 1
                  </p>
                  <p className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:cursor-pointer dark:bg-blacksection dark:text-white">
                    Category 2
