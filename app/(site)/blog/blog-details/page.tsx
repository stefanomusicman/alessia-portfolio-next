        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex flex-col-reverse gap-7.5 lg:flex-row xl:gap-12.5">
            <div className="md:w-1/2 lg:w-[32%]">
              <div className="animate_top mb-10 rounded-md border border-stroke bg-surface p-3.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
                <form
              ...
              <div className="animate_top mb-10 rounded-md border border-stroke bg-surface p-9 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md border border-stroke bg-surface p-7.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection md:p-10">
